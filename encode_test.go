...
func TestPrefixCode(t *testing.T) {
	...
	testcases := []struct {
		...
		{
			in: "00000000 00000000 11111111 00000000  00000000 00000000 00000000 10000000",
			want: output{
				code:       binstr2u8("0100"),
				nZeroBytes: 2,
			},
		...
		{
			in: "00000000 00000000 00000000 00000000  00000000 00000000 11111111 10000000",
			want: output{
				code:       binstr2u8("1010"),
				nZeroBytes: 6,
			},
	...
	for i, tc := range testcases {
		e := newEncoder()
		have := output{}
		have.code, have.nZeroBytes = e.prefixCode(binstr2u64(tc.in))
